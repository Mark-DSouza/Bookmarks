...
b11 = Book.create(title: "The Purpose of Life", author: "Mark D'Souza", description: "The insightful coder reveals the purpose of life.", publisher: "Philip Press", weeks_on_list: 89, rank_this_week: 11)
b12 = Book.create(title: "The Singularity", author: "Kram Azuos", description: "The insightful coder reveals the way to achieve the singularity", publisher: "Philip Press", weeks_on_list: 98, rank_this_week: 12)
...
Review.create(comment: "Revealing . . . It has shown us for the true purpose of life", author: "USA Today", book_id: b11.id)
Review.create(comment: "Insightful . . . It has shown us for the true purpose of life", author: "The New Yorker", book_id: b11.id)

Review.create(comment: "Revealing . . . It has shown us for the true purpose of the singularity", author: "USA Today", book_id: b12.id)
Review.create(comment: "Amazing . . . It has shown us for the true purpose of the singularity", author: "The Wall Street Journal", book_id: b12.id)